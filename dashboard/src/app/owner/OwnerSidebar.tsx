...
function NavLink({ href, icon, label, isActive }: NavLinkProps) {
    return (
        ...
        >
            <div className={`w-5 h-5 ${isActive ? 'text-amber-400' : ''}`}>
                {icon}
            </div>
...
export default function OwnerSidebar({
    ...
    return (
        <aside className="fixed inset-y-0 left-0 w-64 backdrop-blur-xl bg-white/5 border-r border-white/10 z-30">
            {/* Logo */}
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-white/10 bg-slate-900/80">
                <div className="flex items-center gap-3 px-2 py-2 mb-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-amber-400 to-orange-400 rounded-full flex items-center justify-center text-white font-semibold text-sm">
